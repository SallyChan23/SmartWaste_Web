...
<style>  
    ...
    <div class="container d-flex justify-content-end mb-4" >
        <form method="GET" action="{{ route('mission.index') }}" class="d-inline-block d-flex align-items-center flex-row" >
            <div class="me-2">
                <select name="sort" id="sort" class="form-select" style="width: 150px; color: var(--darkgreen); border-color: var(--darkgreen);" onchange="this.form.submit()">
                    <option value="title" {{ request('sort') == 'title' ? 'selected' : '' }}>@lang('mission.sort_name')</option>
                    <option value="totalPoints" {{ request('sort') == 'totalPoints' ? 'selected' : '' }}>@lang('mission.sort_points')</option>
                </select>
            </div>
            ...
            <div class="me-2">
                <select name="order" id="order" class="form-select" style="width: 150px; color: var(--darkgreen); border-color: var(--darkgreen);" onchange="this.form.submit()">
                    <option value="asc" {{ request('order') == 'asc' ? 'selected' : '' }}>@lang('mission.asc')</option>
                    <option value="desc" {{ request('order') == 'desc' ? 'selected' : '' }}>@lang('mission.desc')</option>
                </select>
            </div>
        </form>
    </div>
