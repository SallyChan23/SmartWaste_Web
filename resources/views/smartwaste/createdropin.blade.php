        ...
        <div class="d-flex flex-column justify-content-center align-items-center my-2">
            <div class="">
                ...
                <div class="mb-3 p-5 rounded-3" style="background-color: #F4F7F0; width: 75rem">
                    ...
                    <div class="d-flex mb-3">
                        <div class="me-5">
                            ...
                            <div>
                                <input type="radio" value="2 bottles" name="quantity"/>
                                <label>2 bottles</label>
                            </div>
                            <div>
                                <input type="radio" value="10 bottles" name="quantity"/>
                ...
                <div style="width: 100%" class="d-flex justify-content-center">
                    <button style="background-color: #183F23; color: white; border:none" class="py-2 px-5 rounded-3">Submit</button>
                </div>
            </div>
        </div>
    </div>
